...
\begin{frame}[noframenumbering]
  \begin{figure}[t]
    \centering
    \includegraphics[width=.65\columnwidth]{halfway-g1}
...
\begin{frame}[noframenumbering]
  \begin{figure}[t]
    \centering
    \includegraphics[width=.65\columnwidth]{halfway-g8}
...
\begin{frame}[noframenumbering]
  \begin{figure}[t]
    \centering
    \includegraphics[width=.65\columnwidth]{inserted-g1}
...
\begin{frame}[noframenumbering]
  \begin{figure}[t]
    \centering
    \includegraphics[width=.65\columnwidth]{inserted-g8}
