...
all hybrid method rod worth values fall within one or two sigma range of OpenMC.

Due to the experimental procedure of computing integral rod worth from cumulative differential rod
worth measurements, the uncertainty range of the \gls{MSRE} data scales with rod position.
...
Table \ref{table:rod-worth} shows the total rod worth of Rod 1. 
