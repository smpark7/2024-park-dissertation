...
\begin{figure}[p]
  \centering
  \includegraphics[width=0.8\columnwidth]{count-rate}
...
\begin{figure}[p]
  \centering
  \includegraphics[width=0.8\columnwidth]{count-rate-interp}
  ...
  \includegraphics[width=0.8\columnwidth]{integral-count-interp}
  \caption{Integral neutron count during the rod drop experiment from \gls{MSRE} experimental data
