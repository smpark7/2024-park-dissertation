...
\begin{gather}
  ...
  \end{bmatrix},
%  \mathbb{F}_p\bm{\Psi} = \frac{1}{4\pi} \mathbb{F}_{p,0}\bm{\phi} =
%  \begin{bmatrix}
%    \frac{1}{4\pi}\chi_{p,1}(1-\beta)\sum^G_{g'=1}\nu\Sigma_{f,g'}\phi_{g'} \\
%    \frac{1}{4\pi}\chi_{p,2}(1-\beta)\sum^G_{g'=1}\nu\Sigma_{f,g'}\phi_{g'} \\
%    \vdots \\
...
%  \mathbb{L}^{-1}_2\mathbb{L}\frac{\partial}{\partial t}\frac{\bm{\Psi}}{\bm{v}} -
%  \mathbb{L}^{-1}_2\mathbb{L}^2_1 \bm{\Psi} + \mathbb{L}_2\bm{\Psi} = \mathbb{L}^{-1}_2\mathbb{L}
%  \mathbb{S}\bm{\Psi} + \mathbb{L}^{-1}_2\mathbb{L}\bm{Q}
  \shortintertext{where}
  \begin{align*}
