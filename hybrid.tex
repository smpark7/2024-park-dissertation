...
selection through 1-D test case results in Chapter \ref{chap:hybrid-verification}.
...
linear anisotropies in the flux. However, as I will show in Chapter \ref{chap:hybrid-verification},
...
Results in Chapter \ref{chap:hybrid-verification} will show that transport correction values
...
Here, I use Case 3b of the 1-D test cases to be covered in Chapter \ref{chap:hybrid-verification}
...
\begin{figure}[htb!]
    ...
    \caption{The reference and hybrid drift ($\vec{D}_g$) distributions for group 1 and 8 calculated
      from $S_8$ and $S_8$-diffusion simulations. The correction region $V_1$ spans $x=0$ cm to
      $x=10$ cm.}
    \label{fig:3b-drift}
\end{figure}
