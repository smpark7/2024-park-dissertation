...
\subsubsection{Weak Form of the Multigroup Neutron Transport Equations}
...
exist for the choice of the angular quadrature set \left{\hat{\Omega}_d,w_d | d=1,\dots,N_d\right}.
