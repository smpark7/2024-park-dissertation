\chapter{Numerical Implementation of Neutronics Solvers in Python} \label{chap:implementation}
...
\chapter{3-D \gls{MSRE} Neutron Flux Distributions}

This appendix contains figures showing the group 1 and 8 neutron flux distributions in the 3-D
\gls{MSRE} full-core model with Rod 1 inserted by 27.5 and 51 inches.

\begin{figure}[p]
  \centering
  \includegraphics[width=\columnwidth]{halfway-g1}
...
\begin{figure}[p]
  \centering
  \includegraphics[width=\columnwidth]{halfway-g8}
...
\begin{figure}[p]
  \centering
  \includegraphics[width=\columnwidth]{inserted-g1}
...
\begin{figure}[p]
  \centering
  \includegraphics[width=\columnwidth]{inserted-g8}
